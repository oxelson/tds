...
#### `catalog.xml` 
* The main TDS **root** catalog.
* Acts as both the main client and configuration catalogs.
*


#### `enhancedCatalog.xml` 
* An example catalog that comes with the TDS for you to reference.
* It is referenced from `catalog.xml`.
